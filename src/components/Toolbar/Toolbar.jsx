export function Toolbar({activeCategory, setActiveCategory, sort, setSort}){
  ...
  return(
    <div className="flex gap-2">
      <div className="border rounded-lg h-9 px-4 flex flex-1 border-gray bg-white dark:bg-fundo">
      ...
      <div className="border rounded-lg h-9 px-4 flex flex-1 p-1 border-gray bg-white dark:bg-fundo">
